...
plot1 <- ggplot(samples, aes(x = network.delinquency , group = Centrality)) +
  ...
  labs(title = "The Conditional Effects of Network Structure and Form on Victimization", subtitle = "The Interaction Effects of Centrality & Network Delinquency", x = "Average Delinquency in Friendship Network", y = "Probability of Victimization") +
  scale_colour_pander() +
  scale_fill_pander() +
  theme_pander() + 
...
plot2 <- ggplot(samples, aes(x = network.delinquency , group = Popularity)) +
  ...
  labs(title = "The Conditional Effects of Network Structure and Form on Victimization", subtitle = "The Interaction Effects of Popularity & Network Delinquency", x = "Average Delinquency in Friendship Network", y = "Probability of Victimization") +
  scale_colour_pander() +
  scale_fill_pander() +
  theme_pander() + 
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))
