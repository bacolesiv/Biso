...
The priors used in the analysis were chosen for their lack of informativeness. They are very gently regularizing, but will be overwhelmed by even moderate evidence.

To understand the combined effect of network structure and content on victimization interaction terms where added to the logistic regression models and plotted. 
