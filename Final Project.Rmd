...
race.victim <- mydata.c %>%
  ...
  annotate("text", x = 8, y = 0.2, label = expression(mu), color = "darkred") +
  coord_flip() +
...
plot1 <- ggplot(samples, aes(x = network.delinquency , group = Centrality)) +
  ...
  labs(title = "The Conditional Effects of Network Content and Form on Victimization", subtitle = "The Interaction Effect of Centrality & Network Delinquency", x = "Average Delinquency in Friendship Network", y = "Probability of Victimization", caption = "Figure 2") +
  scale_colour_pander() +
  scale_fill_pander() +
  theme_pander() + 
...
plot2 <- ggplot(samples, aes(x = network.delinquency , group = Popularity)) +
  ...
  labs(title = "The Conditional Effects of Network Content and Form on Victimization", subtitle = "The Interaction Effect of Popularity & Network Delinquency", x = "Average Delinquency in Friendship Network", y = "Probability of Victimization", caption = "Figure 3") +
  scale_colour_pander() +
  scale_fill_pander() +
  theme_pander() + 
  theme(text = element_text(family = "Times"), plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5)) +
